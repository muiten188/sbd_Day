    ...
    renderFlatListItem(dataItem) {
        ...
        return (<Grid style={{ width: '100%', height: 80, marginBottom: 6, paddingTop: 10 }}>
            ...
            <Col style={{ justifyContent: 'center', alignItems: 'flex-start' }}>
                <TouchableOpacity onPress={() => { Actions.home({ screenId: 'locationDetail' }) }}>
                    <Text>
                        <Text style={{ fontWeight: '500' }}>{I18n.t('Map')} 01: </Text>
                        <Text style={{ textDecorationLine: 'underline' }}>{this.textEclipse("Hotel Location")}</Text>
                    </Text>
                </TouchableOpacity>
                {/* <Text>
