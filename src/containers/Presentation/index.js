...
class Presentation extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        // const { searchErorr } = this.props.presentationReducer;
        // const { clearErrorSearch } = this.props.PresentationAction;
        // if (searchErorr) {
    ...
    renderFlatListItem(dataItem) {
        ...
        return (<Grid style={{ width: '100%', height: 80, marginBottom: 6, paddingTop: 10 }}>
            ...
            <Col style={{ justifyContent: 'center', alignItems: 'flex-start' }}>
                <TouchableOpacity onPress={() => { Actions.home({ screenId: 'presentationDetail' }) }}>
                    <Text>
                        Topic 1 
                    <Text style={{ textDecorationLine: 'underline' }}>{this.textEclipse("Digital transformotion in SBD")}</Text>
                    </Text>
                </TouchableOpacity>
