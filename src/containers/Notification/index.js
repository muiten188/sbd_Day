...
class Notification extends Component {
  ...
  renderFlatListItem(dataItem) {
    ...
    return (<Grid style={{ width: '100%', minHeight: 80, marginBottom: 6, paddingTop: 10 }}>
      ...
      <Col style={{ justifyContent: 'center', alignItems: 'flex-start', borderWidth: 0.5, padding: 4 }}>
        <TouchableOpacity onPress={() => { Actions.home({ screenId: 'notifiDetail' }) }}>
          <Text style={{ fontWeight: '500' }}>Welcome to SBD Day </Text>
          <Text style={{ fontWeight: '100', fontSize: 12 }}>12/09/2018 10:44:23 </Text>
          <Text style={{}}>{this.textEclipse("Thank you for joining us today It is our pleasure to meet you here...meet ")}</Text>
        </TouchableOpacity>
      </Col>
