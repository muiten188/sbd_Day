export const API_HOST_BASE = 'http://172.28.42.115:8090/';//'http://event.easylink.vn/event-manager-api/'
...
export const GET_PRODUCT_BY_QRCODE=`${API_HOST}product/scanner`
