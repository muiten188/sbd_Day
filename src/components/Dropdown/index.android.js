  ...
  render() {
    ...
    return (
      <Item style={[style, {flex:1}]} error={error}>
        ...
        <Icon name="arrow-down" style={{position: 'absolute', top: 0, bottom: 0, right: 0,width:40,zIndex:-999}} />
        <Picker style={{ borderWidth:1,position: 'absolute', top: 0, left: 0, bottom: 0, right: 0, backgroundColor:'transparent'  }}
          mode="dropdown"
